                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl">
                           ...
                           if (isset($_POST['viewlocation'])) {
                            ...
                            if (mysqli_num_rows($results) == 1) { // user found
                                $viewlocation = mysqli_fetch_assoc($results);
                                if ($viewlocation['user_type'] == 'user1') {
                                    include("./map/index.php");
                                    echo "<br>";
                                    echo "<a href='./map/index.php'>View Full Location</a>";
                                }
                                else if($viewlocation['user_type'] == 'user2')
                                {
                                    echo "<a href='./map/map1.php'>View Full Location</a>";
                                }
                                else if($viewlocation['user_type'] == 'user'){
                                    echo "<h2>No Data</h2>";
                                }
                            }
                        }
                        ?>
                                                        <br>
                                                        <br>
                                                        <button name="viewlocation">View Location</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
