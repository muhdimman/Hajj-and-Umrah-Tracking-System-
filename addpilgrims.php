                                            ...
                                            <div class="card shadow mb-4">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <?php
                                                        ...
                                                        $query=mysqli_query($conn,"SELECT * FROM users WHERE user_type='user'OR user_type='user1' OR user_type='user2' AND mutawif_id=!$mutawwif AND mutawif_id=!'0'");
                                                        if (mysqli_num_rows($query) > 0) {
                                                            echo '<form action="../fyp/action.php" method="POST">
