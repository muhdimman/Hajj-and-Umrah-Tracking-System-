...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <?php
         include './navbar/mutawifnavbar.php';
          ?>                            
        ...
        if(isset($_POST['editmutawif']))
        {
            ...
            $update = "UPDATE mutawif SET username='$username',email='$email',nphone='$nphone',location='$location',birthday='$birthday',fullname='$fullname' where id='$id'";
    ...
    <h1>Update Profile for Mutawif</h1>
    <hr class="mt-0 mb-4">
    <form  method="post">
        <div class="row">
            <div class="col-xl-8">
