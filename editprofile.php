...
<head>
    ...
    <link
        href="https://fonts.googleais.com/css?family=Nunito:200,200i,300,300i,400,400i,600,600i,700,700i,800,800i,900,900i"
        rel="stylesheet">
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        if(isset($_POST['edit']))
        {
            ...
            $update = "UPDATE users SET username='$username',email='$email',location='$location',nphone='$nphone',birthday='$birthday',passport='$passport',ic='$ic',visa='$visa',fullname='$fullname' where id='$id'";
            ...
            if (count($errors) == 0) {
                if($sql2)
                {
                    echo "<script>window.location.href='./editprofile.php';
                        ...
                        <div class="col-xl-8">
                            ...
                            ?>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input class="form-control" id="inputLastName" type="text" name="email"
                                        ...
                                        <div class="row gx-3 mb-3">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input class="form-control" id="inputPhone" type="text" name="passport"
                                                    placeholder="passport" value="<?php echo $row['passport']; ?>">
                                            </div>
                                            <!-- Form Group (birthday)-->
                                            <div class="col-md-6">
                                                <label class="small mb-1" for="inputBirthday">Visa</label>
                                                <input class="form-control" id="inputBirthday" type="text" name="visa"
                                                    placeholder="Enter your visa" value="<?php echo $row['visa']; ?>">
                                            </div>
                                        </div>
                                        <!-- Form Row        -->
                                        <div class="mb-3">
                                            <label class="small mb-1" for="inputLocation">Ic number</label>
                                            <input class="form-control" id="inputLocation" type="text" name="ic"
                                        ...
                                        <div class="row gx-3 mb-3">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input class="form-control" id="inputPhone" type="text" name="nphone"
                                                    placeholder="Enter your phone number"
                                                    value="<?php echo $row['nphone']; ?>">
                                            </div>
                                            <!-- Form Group (birthday)-->
                                            <div class="col-md-6">
                                        ...
                                        <button name="edit" class="btn btn-primary" type="submit" name="edit">Save
                                            changes</button>
                                    </form>
                                </div>
                            </div>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            <small>
                                <a href="index.php?logout='1'" style="white"><button
