                            ...
                            <div class="card shadow mb-4">
                                ...
                                <!-- End of Content Wrapper -->
                                    ...
                                    if(isset($_POST['groups']))
                                    {
                                        ...
                                        $update = "UPDATE users SET groupno='$groupno',agency='$agency' where id='$id'";
                                        ...
                                        if(empty($groupno))
                                        {
                                            array_push($errors,"Your group no is required");
                                        }
                                            ...
                                            <div class="card mb-4">
                                                ...
                                                <div class="card-body">
                                                    <form>
                                                        ...
                                                        <!-- FUll NAME!-->
                                                        <div class="mb-3">
                                                                <label class="small mb-1" for="inputtravelagency">Enter Your Travel Agency</label>
                                                                <input class="form-control" id="inputtravelagency" type="text" name="agency" value="<?php echo $row['agency']; ?>">
                                                        </div>
                                                        
                                                        <!-- <input type="submit" name="edit"> -->
                                                        <button name="groupsmutawif" class="btn btn-primary" type="submit">Save changes</button>
                                                        <?php
                                                        if(isset($_POST['groupsmutawif']))
                                                            {
                                                                $agency = $_POST['agency'];
                                                                ...
                                                                $sql = mysqli_query($conn,$select);
                                                                $row = mysqli_fetch_assoc($sql);
                                                                $update = "UPDATE mutawif SET agency='$agency' where id='$id'";
                                                                $sql2 = mysqli_query($conn,$update);
